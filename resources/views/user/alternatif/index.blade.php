        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('user.alternatif.add') }}" class="btn btn-primary">Tambah</a>
                </div>
                <div class="card-body">
                                    ...
                                    @foreach ($alternatif as $index => $item)
                                        <tr role="row">
                                            ...
                                            <td class="d-flex justify-content-center">
                                                <a href="{{ route('user.alternatif.edit', $item->id) }}" class="badge badge-warning mx-1">Edit</a>
                                                <a href="{{ route('user.alternatif.destroy', $item->id) }}" class="badge badge-danger mx-1">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
